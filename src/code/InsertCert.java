...
/**
 * Servlet implementation class InsertCert
 */
@WebServlet("/InsertCert")
public class InsertCert extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try { 
			...
			PreparedStatement st = con.prepareStatement("insert into certification_feedback values(?, ?, ?)"); 
